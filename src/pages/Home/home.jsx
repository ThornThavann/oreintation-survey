...
export default function Home() {
  return (
    <div>
      ...
      <div className="px-8 py-10 max-w-7xl
       mx-auto font-sans">
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-10 text-center sm:text-left leading-tight">
          អំពីអង្គការដើម្បីភាពញញឹមនៃកុមារ
        </h1>

        {/* Text and images grid */}
        <p className="text-xl sm:text-3xl mb-16   leading-relaxed lg:leading-loose">
  ...
  ចំនួន ៥៥០០ នាក់ជាអតីតសិស្សដែលបច្ចុប្បន្នពួកគេ ទទួលបាននូវការងារ និងកុមារ
  ចំនួន ១២០០ នាក់ត្រូវបានជួយសង្គ្រោះចេញពីទុក្ខវេទនា រួមជាមួយជំនាញ​បណ្តុះ
  បណ្តាលវិជ្ជាជីវៈចំនួន ២០ ត្រូវបានផ្តល់ជូនដោយឥតគិតថ្លៃ អាហារ ៦០០០ ចានត្រូវ
  បានផ្តល់ជូនដល់ពួកគេ និងការពិគ្រោះព្យាបាលជំងឺចំនួន ១៥០០ នាក់ជារៀងរាល់
  សប្តាហ៍។ ប៉េ អេស អឺ ជាអង្គការមួយដែលមិនរកប្រាក់ចំនូលរបស់ប្រទេសបារាំងនិងបានបង្កើត
  ឡើងនៅឆ្នាំ ១៩៩៦ ក្នុងប្រទេសកម្ពុជា មានបុគ្គលិកបម្រើការងារជាង ៦០០ នាក់
  ដើម្បីចូលរួមបំពេញបេសកកម្មក្នុងការផ្តល់ជូនស្បៀងអាហារ ទីជម្រកសមរម្យ
  ការថែទាំវេជ្ជសស្ត្រ ការអប់រំចំណេះដឹងទូទៅពីថ្នាក់ទី ១
  ដល់ថ្នាក់ទី ១២ និងការបណ្តុះ បណ្តាលវិជ្ជាជីវៈជំនាញ
  ...
  និងតាមបណ្តាលខេត្តក្រុងនានាក្នុងប្រទេសកម្ពុជា ដោយចុះទៅដល់ទីតាំងផ្ទាល់។
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mb-20">
          ...
          />
          <div className="bg-orange-500 text-white p-10 rounded shadow-lg flex items-center">
            <p className="text-xl sm:text-4xl leading-relaxed font-medium max-w-prose">
